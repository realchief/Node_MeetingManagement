...
FT.data.data_sources.facebook = {}
FT.data.data_sources.facebook.meta = {}
FT.data.data_sources.facebook.fields = {}
FT.data.data_sources.facebook.equations = {}
FT.data.data_sources.facebook.meta.mappings = {}
FT.data.data_sources.facebook.meta.name = "Facebook"
FT.data.data_sources.facebook.metric_assets = {}
...
FT.data.data_sources.facebook.meta.mappings.all =  {}


$.extend(FT.data.data_sources.facebook.meta.mappings.all,  {
 ...
 */
 ...
 FT.data.data_sources.facebook.fields.page_fans = {
...
FT.data.data_sources.facebook.fields.page_posts_impressions_unique = {
	'name' : 'reach',
	'label' : 'Reach',
...
FT.data.data_sources.facebook.fields.page_engaged_users = {
	'name' : 'engaged_users',
	'label' : 'Engaged Users',
	'description' : '',
	'data' : {
 ...
 FT.data.data_sources.facebook.equations.page_engagement_rate = {
...
FT.data.data_sources.facebook.fields.page_post_engagements = {
	'name' : 'engagements',
	'label' : 'Engagements',
...
FT.data.data_sources.facebook.fields.page_posts_impressions_paid_unique = {
	'name' : 'paid_reach',
	'label' : 'Paid Reach',
...
FT.data.data_sources.facebook.fields.page_posts_impressions_organic_unique = {
	'name' : 'organic_reach',
	'label' : 'Organic Reach',
...
FT.data.data_sources.facebook.fields.page_fan_adds_unique = {
	'name' : 'new_fans',
	'label' : 'Fan Adds',
...
FT.data.data_sources.facebook.fields.page_fan_removes_unique = {
	'name' : 'removed_fans',
	'label' : 'Fan Removes',
...
FT.data.data_sources.facebook.fields.page_positive_feedback_by_type__like = {
	'name' : 'total_likes',
	'label' : 'Total Likes',
...
FT.data.data_sources.facebook.fields.page_positive_feedback_by_type__link = {
	'name' : 'total_shares',
	'label' : 'Total Shares',
...
FT.data.data_sources.facebook.fields.page_positive_feedback_by_type__comment = {
	'name' : 'total_comments',
...
FT.data.data_sources.facebook.fields.page_consumptions_by_consumption_type_unique__link_clicks = {
	'name' : 'link_clicks',
	'label' : 'Link Clicks',
...
FT.data.data_sources.facebook.fields.page_video_view_time = {
	'name' : 'video_time_sec',
...
FT.data.data_sources.facebook.fields.page_video_views = {
...
FT.data.data_sources.facebook.fields.total_posts = {
	'name' : 'total_posts',
	'label' : 'Total Posts',
...
FT.data.data_sources.facebook.meta.fields = [];
$.each( FT.data.data_sources.facebook.fields, function(fieldName, field) {
	FT.data.data_sources.facebook.meta.fields.push(fieldName)
})
 ...
 */
 ...
 FT.data.data_sources.facebook.equations.minutes_consumed = {
 ...
 FT.data.data_sources.facebook.equations.hours_consumed = {
...
FT.data.data_sources.facebook.equations.days_consumed = {
 	'label' : 'Days Consumed',
 ...
 FT.data.data_sources.facebook.equations.years_consumed = {
 ...
 FT.data.data_sources.facebook.equations.net_new_fans = {
 	'label' : 'Net New Fans',
...
FT.data.data_sources.facebook.meta.timeframes = {}

FT.data.data_sources.facebook.meta.timeframes.current = {
	period : "Month",
	start_date: "Not Set: 10-01-2017",
	end_date: "Not Set: 10-31-2017",
}

FT.data.data_sources.facebook.meta.timeframes.compared = {
	period : "Month",
