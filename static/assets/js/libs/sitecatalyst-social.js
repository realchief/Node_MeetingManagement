...
var s=s_gi(FT_GLOBALS.s_account)
/************************** CONFIG SECTION **************************/
...
//s.linkInternalFilters="javascript:,domaininspiration.com,"
//s.linkLeaveQueryString=false
s.linkInternalFilters="javascript:,domaininspiration.com,facebook.com,twitter.com,loosegrip.net"
...
s.eVar1=s.eVar2=s.prop19="D=v0";

/* Timeparting EST */
var theDate=new Date();
var currentYear=(theDate.getFullYear());
s.prop13=s.getTimeParting('h','-5',currentYear); // Set hour
s.prop14=s.getTimeParting('d','-5',currentYear); // Set day
s.eVar9=s.getValOnce(s.prop13,'s_evar9',0);
s.eVar10=s.getValOnce(s.prop14,'s_evar10',0);

/* Repeat Visits */
s.prop18=s.getNewRepeat();
s.eVar6=s.getValOnce(s.prop18,'s_evar6',0);
s.prop11=s.getVisitNum();
s.eVar7=s.getValOnce(s.prop11,'s_evar7',0);

/* Misc */
s.channel="Social MeFTa"
s.server=window.location.hostname;
s.server = s.server.toLowerCase();
s.prop15=document.title;
s.prop16="D=g" // page url;
s.prop23="D=User-Agent"
s.prop24="D=s_vi" // visitor ID
s.prop40="D=s" // screen res
s.prop41="D=bw" // browser width
s.eVar49="20130403"
s.eVar14='D=pageName'
...
s.visitorNamespace="verisigninc"
s.trackingServer="verisigninc.112.2o7.net"
...
+");return true');s.bcr=function(){var s=this;if(s.bct&&s.bce)s.bct.FTspatchEvent(s.bce);if(s.bcf){if(typeof(s.bcf)=='function')s.bcf();else if(s.bct&&s.bct.href)s.d.location=s.bct.href}s.bct=s.bce=s"
...
+"#\")==0||h.indexOf(\"about:\")==0||h.indexOf(\"javascript:\")==0)h=0;t=a.target;if(e.target.FTspatchEvent&&h&&(!t||t==\"_self\"||t==\"_top\"||(s.wd.name&&t==s.wd.name))){e.stopPropagation();e.stopI"
+"mmeFTatePropagation();e.preventDefault();n=s.d.createEvent(\"MouseEvents\");n.initMouseEvent(\"click\",e.bubbles,e.cancelable,e.view,e.detail,e.screenX,e.screenY,e.clientX,e.clientY,e.ctrlKey,e.alt"
...
+"+=s.vl_l2;s.va_t=s.sp(s.vl_t,',');s.vl_g=s.vl_t+',trackingServer,trackingServerSecure,trackingServerBase,fpCookieDomainPeriods,FTsableBufferedRequests,mobile,visitorSampling,visitorSamplingGroup,dy"
